...
\documentclass[finnish]{tktltiki2}
  ...
  \subsection{Gradienttimenetelmä}
    ...
    %TODO tsekkaa onks faktat oikein tässä
  ...
  \subsection{Takaisinvirtausalgoritmi}
    ...
    %Esimerkiksi viimeisen piilokerroksen neuroneiden virhe on niihin yhdistettyjen ulostulokerroksen neuroneiden virheiden summa $E = E_{1}^o + ... + E_{i}^o $, joten laskettaessa ensin virheet ulostulokerrokselle laskemme samalla myös hyödyllisiä välituloksia piilokerroksen virheen selvittämiseen.
    %Esimerkiksi viimeisen piilokerroksen neuroneiden ulostuloarvojen vaikutus on niihin yhdistettyjen ulostulokerroksen neuroneiden virheiden summa, joten laskettaessa ensin virheet ulostulokerrokselle laskemme samalla myös hyödyllisiä välituloksia piilokerroksen virheen selvittämiseen.


    %TODO Vai jätetäänkö käsittely esimerkkiin?
    %TODO bias
    %Kun virhefunktion derivaatta neuronin ulostuloarvon suhteen tiedetään, virhefunktion derivaatta neuronien $n_i$ ja $n_j$ välillä olevan verkon painon $w_{ij}$ suhteen 
    %Kun $E_{koko}$ derivoidaan jonkin tietyn ulostuloarvon suhteen, ulostulokerroksessa jäljelle jää $n_{j}^{out} - z_j^{out}$\cite{Nielsen-neural}, ja muissa kerroksissa 

    %$$ \frac{\partial E_{koko}}{\partial n_{j+1}^{out}}$$
    % ^ nielsenistä löytyy chap2 outputlayerin virheen (a - y) homma
