...
\documentclass[finnish]{tktltiki2}
 ...
 %todo liian lyhyt ja viite pitää etsiä (löytyy nielsenistä myös)

  
  \section{Konvolutionaalisten neuroverkkojen rakenne}

  %Konvolutionaalisilla neuroverkoilla pystytään ottamaan neuroverkon rakenteessa huomioon sovelluskohteiden luontaisia ominaisuuksia, kuten kuvien translationaalinen invarianssi \cite{lecun-et-al-98-convnets}.
